...
//import { Be } from 'rxjs/BehaviorSubject';
...
kk
   ...
   private _hasBeenInitialized = new Rx.BehaviorSubject(false);

    /**
   * Observer for the keycloak events
   */
  private _keycloakEvents$: Rx.Subject<KeycloakEvent>;

  constructor() {
    this._keycloakEvents$ = new Rx.Subject<KeycloakEvent>();
  }
	

	isReady(): Rx.BehaviorSubject<boolean> {
